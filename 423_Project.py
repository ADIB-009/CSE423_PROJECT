...
def keyboardListener(key, x, y):
    global player_pos, player_life, score, fpp, game_state, enemy_spaceship, asteroid, map_edge, camera_pos, bullet, ang, ship_color, ship_speed, t1, d, h
...
def idle():
    ...
    global bullet, enemy_spaceship, player_pos, game_state, ship_speed
